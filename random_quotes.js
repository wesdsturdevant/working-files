...
Module.register("random_quotes",{
	...
	defaults: {
		...
		quotes: {
			...
			life: [
                ...
                "Gnothi Sueaton - Socrates",
                "A wiseman, therefore, proportions his beliefs to the evidence. - David Hume", 
			...
			motivational: [
                ...
                "Carpe diem, quam minimal creduala postero est. / Sieze the day, put little trust in tomorrow. ~ Horace",
			],
			positive: [
	...
	getDom: function() {
		...
		quote.className = "bright_red bold large";
		...
		author.className = "regular xsmall bright_red";
